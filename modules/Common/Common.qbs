    ...
    Rule {
        ...
        prepare: {
            ...
            cmd.sourceCode = function() {
                ...
                f.writeLine('constexpr const char* APP_NAME = "'+product.Common.appName+'";')
                f.writeLine('constexpr const char* APP_TITLE = "'+product.Common.appTitle+'";')
                f.writeLine('constexpr const char* APP_ORG = "'+product.Common.orgTitle+'";')
                f.writeLine('constexpr const char* APP_ORG_DOMAIN = "'+product.Common.orgDomain+'";')
                f.writeLine('constexpr const char* SOURCE_ROOT = "'+product.sourceDirectory+'";')
